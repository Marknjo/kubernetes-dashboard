...
start)
   ...
   kubectl apply -f ~/local-dev/kubernetes/dashboard/dashboard-admin.yaml >/dev/null 2>&1
...
stop)
   ...
   kubectl delete -f ~/local-dev/kubernetes/dashboard/dashboard-admin.yaml >/dev/null 2>&1
   echo $msgstopped
   ;;
